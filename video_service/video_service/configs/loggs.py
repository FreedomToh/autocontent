...
LOGGING = {
    ...
    'filters': {
        'warning': {
            '()': 'video_service.configs.loggs.WarningFilter',
        },
        'debug': {
            '()': 'video_service.configs.loggs.DebugFilter',
        },
        'info': {
            '()': 'video_service.configs.loggs.InfoFilter',
        },
        'error': {
            '()': 'video_service.configs.loggs.ErrorFilter',
        },
        # 'require_debug_true': {
