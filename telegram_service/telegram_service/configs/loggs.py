...
LOGGING = {
    ...
    'filters': {
        'warning': {
            '()': 'telegram_service.configs.loggs.WarningFilter',
        },
        'debug': {
            '()': 'telegram_service.configs.loggs.DebugFilter',
        },
        'info': {
            '()': 'telegram_service.configs.loggs.InfoFilter',
        },
        'error': {
            '()': 'telegram_service.configs.loggs.ErrorFilter',
        },
        # 'require_debug_true': {
