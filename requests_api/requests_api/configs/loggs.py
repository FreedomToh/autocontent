...
LOGGING = {
    ...
    'filters': {
        'warning': {
            '()': 'requests_api.configs.loggs.WarningFilter',
        },
        'debug': {
            '()': 'requests_api.configs.loggs.DebugFilter',
        },
        'info': {
            '()': 'requests_api.configs.loggs.InfoFilter',
        },
        'error': {
            '()': 'requests_api.configs.loggs.ErrorFilter',
        },
        # 'require_debug_true': {
